...
class WishlistItemRepository extends EntityRepository
{
    ...
    public function makeWish($name, $image, $price, $link, $isPublic, $comment, $quantity, WishlistUser $wishlistUser)
    {
        $itemRepo = $this->getEntityManager()->getRepository('WishlistCoreBundle:Item');
        $newItem = $itemRepo->newItem($name, $image, $price, $link); //, $isPublic, $comment, $quantity, $wishlistUser);
