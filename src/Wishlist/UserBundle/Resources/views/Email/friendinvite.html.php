<html>
    <body style='font-family: helvetica,sans-serif; color: #666666'>
        <p><span style='font-weight: bold; color: #333333'><?php echo $name ?></span> wants to give you a gift but doesn't know what you want. Help them shop for you with Wishenda!</p>
