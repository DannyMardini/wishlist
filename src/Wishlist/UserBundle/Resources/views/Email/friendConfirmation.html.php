<html>
    <body style='font-family: helvetica,sans-serif; color: #666666'>
        ...
        <a href='<?php echo $view['router']->generate('WishlistFrontpageBundle_homepage', array(), true) ?>' style='text-decoration: none; font-weight: bolder'>Log in</a> 
        to check out their Wish list!</p>        
    </body>
</html>
