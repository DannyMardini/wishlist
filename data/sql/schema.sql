...
CREATE TABLE wishlist_user (name VARCHAR(255) NOT NULL, gender BIGINT DEFAULT 1, age BIGINT DEFAULT 18 NOT NULL, email VARCHAR(255) NOT NULL, wishlistuser_id BIGINT AUTO_INCREMENT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX gender_idx (gender), PRIMARY KEY(wishlistuser_id)) ENGINE = INNODB;
