 ...
 * @method Event        setWishlistuserId()  Sets the current record's "wishlistuser_id" value
 ...
 * @method Event        setWishlistUser()    Sets the current record's "WishlistUser" value
 * 
 * @package    wishlist
 * @subpackage model
