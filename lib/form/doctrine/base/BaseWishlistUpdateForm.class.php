...
/**
 * WishlistUpdate form base class.
 *
 * @method WishlistUpdate getObject() Returns the current form's model object
 *
 * @package    wishlist
 * @subpackage form
 ...
 */
abstract class BaseWishlistUpdateForm extends BaseFormDoctrine
{
