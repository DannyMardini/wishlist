function updateFriendList(friends)
{
    ...
    for( var i = 0; i < friends.length; i++)
    {
        ...
        console.log("<li><img class='friendIcon' src='" + friends[i].profileUrl + "'/><a href=''>" + friends[i].firstName + " " + friends[i].lastName +"</a></li>");
        friendlist.append("<li><img class='friendIcon' src='" + friends[i].profileUrl + "'/><a href=''>" + friends[i].firstName + " " + friends[i].lastName +"</a></li>");
    }
}
